...
class Ingredient(AbstractSubmissionModel, AbstractLicenseModel, models.Model):
    ...
    # AGREGADOS POR IN THE FITZONE
    vitamin_a = models.DecimalField(decimal_places=3,
                                 max_digits=6,
                                 blank=True,
                                 null=True,
    ...
    vitamin_c = models.DecimalField(decimal_places=3,
                                 max_digits=6,
                                 blank=True,
                                 null=True,
    ...
    calcium = models.DecimalField(decimal_places=3,
                                 max_digits=6,
                                 blank=True,
                                 null=True,
    ...
    iron = models.DecimalField(decimal_places=3,
                                 max_digits=6,
                                 blank=True,
                                 null=True,
                                 verbose_name=_('iron'),
    ...
    alcohol = models.DecimalField(decimal_places=3,
                                 max_digits=6,
                                 blank=True,
                                 null=True,
    ...
    def clean(self):
        ...
        energy_alcohol = 0
        if self.alcohol:
            energy_alcohol = self.alcohol * ENERGY_FACTOR['alcohol']['kg']

        energy_calculated = energy_protein + energy_carbohydrates + energy_fat + energy_alcohol
...
class BaseMealItem(object):
    ...
    def get_nutritional_values(self, use_metric=True):
        ...
        # Calculos de agregados por ITFZ a la base de datos

        if self.ingredient.vitamin_a:
            nutritional_info['vitamin_a'] += self.ingredient.vitamin_a * item_weight / 100

        if self.ingredient.vitamin_c:
            nutritional_info['vitamin_c'] += self.ingredient.vitamin_c * item_weight / 100

        if self.ingredient.calcium:
            nutritional_info['calcium'] += self.ingredient.calcium * item_weight / 100
        
        if self.ingredient.iron:
            nutritional_info['iron'] += self.ingredient.iron * item_weight / 100
        
        if self.ingredient.alcohol:
            nutritional_info['alcohol'] += self.ingredient.alcohol * item_weight / 100
