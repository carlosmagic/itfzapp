...
function updateIngredientValue(url) {
  ...
  $.get(url, formData, function (data) {
    ...
    $('#value-vitamin_a').html(parseFloat(data.vitamin_a).toFixed(2));
    $('#value-vitamin_c').html(parseFloat(data.vitamin_c).toFixed(2));
    $('#value-calcium').html(parseFloat(data.calcium).toFixed(2));
    $('#value-iron').html(parseFloat(data.iron).toFixed(2));
    $('#value-alcohol').html(parseFloat(data.alcohol).toFixed(2));
  });
}
